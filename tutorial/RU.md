...
- Опция Goroutines в файле конфигурации определяет количество одновременных сканирований. Увеличение этого значения приведет к быстрому сканированию, но также повысит вероятность ошибок и задержек. Если включен DownloadTest или UploadTest, установите Goroutines на 1 для получения точных результатов теста скорости.
